...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/EditableTextInsetsTextField/EditableTextInsetsTextField.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/TapApplication/TapApplication.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/TapEditableView/TapEditableView.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/TapFontsKit/TapFontsKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/TapGLKit/TapGLKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/TapKeychain/TapKeychain.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/TapNetworkManager/TapNetworkManager.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/TapNibView/TapNibView.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/TapResponderChainInputView/TapResponderChainInputView.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/TapSearchView/TapSearchView.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/TapSwiftFixes/TapSwiftFixes.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/TapVisualEffectView/TapVisualEffectView.framework"
